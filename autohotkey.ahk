...
#!k::SnapActiveWindowGrid(2, 1, 1, 1)

; Snap to bottom half of screen
; 2 rows, 1 columns, second row, first column
#!j::SnapActiveWindowGrid(2, 1, 2, 1)



; Snap to Left half of screen
; 1 rows, 2 column, first row, first column
#!h::SnapActiveWindowGrid(1, 2, 1, 1)

; Snap to Right half of screen
; 1 rows, 2 column, first row, 2nd column
#!l::SnapActiveWindowGrid(1, 2, 1, 2)
